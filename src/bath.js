                        ...
                        <div style={{display: Details ? "grid" : "none",
                            ...
                            { Front &&
                                ...
                                <div  key={F.name} className="option_in_subcategory" onClick={() => setDetails(false)}>
                                    <img onClick={() => image_handler_front(F.code) } className='product_image' style={{width:"100%", height:"100%"}} src={F.image} alt="Image" /> 
                            ...
                            { Korpus && 
                                ...
                                <div key={F.name} className="option_in_subcategory">
                                   <img onClick={() => image_handler_korpus(F.code) } className='product_image' src={F.image} style={{width:"90%", height:"90%"}} alt="Image" />
                                   <div className="product_name">{F.name}</div> 
                                </div>
                                )
                            ...
                            { Waschtisch && 
                                ...
                                <div key={F.name} className="option_in_subcategory">
                                    <img className='product_image' src={F.image} alt="Image" style={{width:"100%", height:"100%"}}/>
                                    <div className="product_name">{F.name}</div> 
                                </div>
                                )
                            }
